    ...
    return (
        <>
            ...
            <div className="flex-1 overflow-y-auto p-6 md:p-8 pb-32 bg-slate-50 relative h-full">
                ...
                <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-slate-50 via-slate-50 to-transparent pt-12 pb-6 px-4 pointer-events-none">
                    <form
                        onSubmit={handleCatatSubmit}
                        className="max-w-3xl mx-auto bg-white rounded-full p-2 flex items-center gap-2 shadow-2xl border border-slate-200 focus-within:ring-2 focus-within:ring-blue-100 transition-all pointer-events-auto"
                    >

                        <button type="button" className="w-10 h-10 flex items-center justify-center text-slate-400 hover:text-blue-500 rounded-full hover:bg-blue-50 transition" title="Foto Nota">
                        ...
                        <input
                            type="text"
                            className="flex-1 bg-transparent border-none outline-none text-slate-700 px-2 text-sm placeholder-slate-400 focus:ring-0"
                            placeholder="Catat transaksi atau instruksikan AI (Gemini 2.5)..."
                            value={catatInput}
                            onChange={(e) => setCatatInput(e.target.value)}
                        />


                        <button type="button" className="w-10 h-10 flex items-center justify-center text-slate-400 hover:text-red-500 rounded-full hover:bg-red-50 transition" title="Tahan untuk bicara">
                            <i className="fas fa-microphone"></i>
                        </button>


                        <button type="submit" className="w-10 h-10 flex items-center justify-center bg-blue-600 text-white rounded-full hover:bg-blue-700 transition shadow-md shadow-blue-600/30">
                            <i className="fas fa-paper-plane text-xs translate-y-[1px] -translate-x-[1px]"></i>
                        </button>
                    </form>
                    <p className="text-center text-[10px] text-slate-400 mt-2 pointer-events-auto">
                        Powered by Vertex AI (Gemini Flash). Coba ketik: <span className="italic text-slate-500">"Baru beli ayam potong 5kg harga 150rb"</span>
                    </p>
                </div>
