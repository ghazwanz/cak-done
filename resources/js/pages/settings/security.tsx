                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                Anda akan dimintai PIN aman saat masuk, yang dapat
                                Anda ambil dari aplikasi pendukung TOTP di ponsel Anda.
                            </p>
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                ...
                                akan dimintai PIN aman saat masuk. PIN ini dapat
                                diambil dari aplikasi pendukung TOTP di ponsel Anda.
                            </p>
