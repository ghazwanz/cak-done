...
- [ ] Develop core Catat feature: voice entry + OCR (See [Workflow 01](./01-catat-smart-entry.md)).
...
- [ ] Build Autonomous Inventory & Expiry Watchdog (See [Workflow 02](./02-inventory-watchdog.md)).
...
- [ ] Deploy Predictive Cash Flow Agent (7-day and 30-day forecast) (See [Workflow 03](./03-cashflow-liquidity-agent.md)).
- [ ] Implement personal vs. business fund separation.
- [ ] Build bank-compliant PDF report generator (IAI standard).
- [ ] Develop Cak AI chat interface with data-grounded responses (See [Workflow 04](./04-cak-ai-insights.md)).
